...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 16 2024 г., 16:35
...
(1, 'ООО « Длинное большое название песня»', 978777111, 'г. Тюмень. ул. Фармана Салманова, д. 1', '+7 987 111 111', 'email1@example.com', 1),
(2, 'ООО « Жизнь большое название 2»', 978777112, 'г. Тюмень. ул. Фармана Салманова, д. 2', '+7 987 111 112', 'email2@example.com', 1),
(3, 'ООО « Короткое большое название 3»', 978777113, 'г. Тюмень. ул. Фармана Салманова, д. 3', '+7 987 111 113', 'email3@example.com', 0),
(4, 'ООО « Алый большое название 4»', 978777114, 'г. Тюмень. ул. Фармана Салманова, д. 4', '+7 987 111 114', 'email4@example.com', 1),
(5, 'ООО « Длинное большое название 5»', 978777115, 'г. Тюмень. ул. Фармана Салманова, д. 5', '+7 987 111 115', 'email5@example.com', 1),
(6, 'ООО « Юлок большое название 6»', 978777116, 'г. Тюмень. ул. Фармана Салманова, д. 6', '+7 987 111 116', 'email6@example.com', 1),
...
(15, 'ООО « Сочный большое название 15»', 978777215, 'г. Тюмень. ул. Фармана Салманова, д. 15', '+7 987 111 215', 'email15@example.com', 0),
