...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 18 2024 г., 12:05
...
CREATE TABLE `Carton` (
  ...
  `price` int NOT NULL,
  `nameContractor` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
...
(1, 'ООО « Длинное большое название песня»11', 978777111, 'г. Тюмень. ул. Фармана Салманова, д. 1, telephone = +7 987 333 33-33', '+7 987 333 33-33', 'email1@example.com', 1),
(2, 'ООО « Жизнь большое название 66»', 978777112, 'г. Тюмень. ул. Фармана Салманова, д. 2', '+7 987 333 31-12', 'email2@example.com', 1),
(3, 'ООО « Короткое большое название 333»', 978777223, 'г. Тюмень. ул. Фармана Салманова, д. 3', '+7 987 333 31-13', 'email3@example.com', 0),
...
(16, 'ООО « Длинное большое название 16»', 978777216, 'г. Тюмень. ул. Фармана Салманова, д. 16', '+7 987 333 32-16', 'email16@example.com', 1),
